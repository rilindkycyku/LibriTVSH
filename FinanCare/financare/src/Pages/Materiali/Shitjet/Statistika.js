...
function Statistika() {
  ...
  useEffect(() => {
    const vendosTotalinPerdoruesve = async () => {
      try {
        setTotaleTeNdryshme(data.totaleTeNdryshme);
      } catch (e) {
        console.error(e);
      }
    };
    ...
    const vendosTop15Bleresit = async () => {
      try {
        setTop15Bleresit(data.shfaq15BleresitQytetarMeSeShumtiBlerje);
      } catch (e) {
        console.error(e);
      }
    };
    ...
    const vendosTop15Bizneset = async () => {
      try {
        setTop15Bizneset(data.shfaq15BleresitBiznesorMeSeShumtiBlerje);
      } catch (e) {
        console.error(e);
      }
    };
    ...
    const vendosTop15Produktet = async () => {
      try {
        setTop15Produktet(data.shfaq15ProduktetMeTeShitura);
      } catch (e) {
        console.error(e);
      }
    };
    ...
    const vendosShitjetJavore = async () => {
      try {
        setShitjetJavore(data.TotaletJavore);
      } catch (e) {
        console.error(e);
      }
    };
    ...
    const vendosShitjetMeParagon = async () => {
      try {
        setShitjetMeParagon(data.ShitjetMeParagonSipasOperatorit);
      } catch (e) {
        console.error(e);
      }
    };
